package com.vkc.strabo.activity.gifts

import android.app.Activity
import com.vkc.strabo.constants.VKCUrlConstants
import com.vkc.strabo.activity.gifts.model.GiftsModel
import androidx.recyclerview.widget.RecyclerView
import com.vkc.strabo.activity.gifts.model.VoucherModel
...
import com.vkc.strabo.activity.gifts.adapter.GiftsAdapter
...
import com.vkc.strabo.activity.cart.CartActivity
 ...
 */
class GiftsActivity : Activity(), VKCUrlConstants, View.OnClickListener {
        ...
        spinnerVoucher!!.onItemSelectedListener = object : OnItemSelectedListener {
            override fun onItemSelected(
                ...
                if (position > 0) {
                    ...
                    textCoupon!!.text = listVouchers!![position - 1].coupon_value + " Coupons"
                                    ...
                                    if (status.equals("Success", ignoreCase = true)) {
                                        ...
                                        if (voucherArray.length() > 0) {
                                            ...
                                            for (i in listVouchers!!.indices) {
                                                listVoucher.add(listVouchers!![i].voucher_value + " ( " + listVouchers!![i].coupon_value + " Coupons )")
                                            }
