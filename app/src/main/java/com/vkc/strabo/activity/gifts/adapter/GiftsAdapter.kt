package com.vkc.strabo.activity.gifts.adapter
...
import com.vkc.strabo.activity.gifts.adapter.GiftsAdapter.MyViewHolder
...
class GiftsAdapter(
...
) : RecyclerView.Adapter<MyViewHolder>(), VKCUrlConstants {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        Picasso.with(mContext).load(gift_name)
            .transform(MaskTransformation(mContext, R.drawable.india)).resize(300, 300)
