package com.vkc.strabo.activity.dealers

import android.app.Activity
import com.vkc.strabo.constants.VKCUrlConstants
import com.vkc.strabo.manager.HeaderManager
import com.vkc.strabo.activity.dealers.adapter.DealersListAdapter
 ...
 */
class DealersActivity : Activity(), VKCUrlConstants, View.OnClickListener {
    lateinit var  mContext: Activity
    lateinit var listDealers: ArrayList<DealerModel>
        ...
        editSearch!!.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence, start: Int, before: Int, count: Int) {
                /*if (s.length() == 0) {
                  ...
                  */
                /*  for (int i = 0; i < listDealers.size(); i++) {
                        if (listDealers.get(i).getName().contains(s.toString())) {
                            listViewDealer.setSelection(i);
                            // break;
                        }
                    }*/
                ...
                /*   if (s.length() == 0) {
                    ...
                    for (int i = 0; i < listDealers.size(); i++) {
                        ...
                        if (listDealers.get(i).getName().toUpperCase().replaceAll(" ","").contains(s.toString().toUpperCase().replaceAll(" ", ""))) {
                            listViewDealer.setSelection(i);
                            break;
                        }
                    }
                ...
                /* if (s.length() == 0) {
                    ...
                    for (int i = 0; i < listDealers.size(); i++) {
                        ...
                        if (listDealers.get(i).getName().toLowerCase().contains(s.toString().toLowerCase())) {
